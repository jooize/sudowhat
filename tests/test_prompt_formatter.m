...
static void test_format_antiinjection_newline_count(void) {
     ...
     * the text survives (the spelling is not the guarantee) but its
    ...
    OK([out3 containsString:@"EXECUTE\\n/bin/sh"], "the label text itself is not censored");
